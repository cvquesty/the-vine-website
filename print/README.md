...
2. Right-click → "Save image as..." → save as PDF, or use **Print → Save as PDF**.
...
**Specs:**
- Half letter: **5.5" × 8.5"** (portrait)
- Contains logo, Ocoee illustration, service info, and community group highlights.
...
- **Surfaces:** `#12121a`, `#1a1a24`
- **Primary accent:** `#5cb85c` (vine green)
...
- (423) 216-4433
- Sundays 10:30am — Athens, Tennessee
...
*All designs use the same SVGs and color palette as the website. For edits, modify the source files and re-export.*

**The Vine Church — Athens, TN**
*hello@thevineathens.church • thevineathens.church*
